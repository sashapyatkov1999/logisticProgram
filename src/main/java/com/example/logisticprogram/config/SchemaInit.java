...
public class SchemaInit {
    ...
    public static class SchemaInitBean implements InitializingBean {
        ...
        @Autowired
        public SchemaInitBean(DataSource dataSource, @org.springframework.beans.factory.annotation.Value("${spring.liquibase.liquibase-schema}") String liquiBaseSchema, @Value("${spring.liquibase.default-schema}") String defaultSchema) {
